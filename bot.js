...
class bot {
  ...
  constructor () {
    ...
    this.dict['schach'] = 'Willst du schach spielen?'
    this.dict['wetter'] = 'heute ist es sehr frisch'
    this.dict['Tag'] = 'Oh ja, das ist mein Lieblingstag'
    this.dict['wo ist'] = 'wahrscheinlich nicht hier'
    this.dict['Sport'] = "Was ist dein Lieblingssportart?"
    this.dict['lernen'] = 'lernen lernen und nochmal lernen'
    this.dict['Vorlesung'] = 'und kannst du was neues jetzt von dieser Vorlesung'
    this.dict['Mathe'] = 'in Mathe kann man sich relaxen'
    this.dict['Hallo'] = 'Hallo, mein lieber Freund'
    this.dict['Uhr'] = 'Leider, hab keine dabei'
    this.dict['Proffessor'] = 'Ou, Ich kennen diesen Proffessor! Er ist sehr cool'
    ...
    this.client.on('connect', function (connection) {
      ...
      // Es kann immer seind, dass sich der Client disconnected (typischer Weise, wenn der Server nicht mehr da ist) 
     ...
     // Hier senden wir unsere Kennung damit der Server uns erkennt. 
      function joinGesp () {
        if (connection.connected) {
          connection.sendUTF('{"type": "join", "name":"Divinus"}')
        }
      }
      joinGesp()
    })
